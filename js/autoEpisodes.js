...
const collapse7 = [new Episode("Arrow", 8, 1, "Starling City", false),
    ...
    new Episode("Supergirl", 5, 1, "Event Horizon", false),
    new Episode("Supergirl", 5, 2, "Stranger Beside Me", false),
    new Episode("Supergirl", 5, 3, "Blurred Lines", false),
    new Episode("Supergirl", 5, 4, "In Plain Sight", false),
    ...
    new Episode("Batwoman", 1, 2, "The Rabbit Hole", false),
    new Episode("Batwoman", 1, 3, "Down Down Down", false),
    new Episode("Batwoman", 1, 4, "Who Are You?", false),
    ...
    new Episode("The Flash", 6, 3, "Dead Man Running", false),
    new Episode("The Flash", 6, 4, "There Will Be Blood", false),
