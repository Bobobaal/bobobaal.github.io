...
const collapse7 = [new Episode("Supergirl", 5, 1, "Event Horizon", true),
    ...
    new Episode("Supergirl", 5, 5, "Dangerous Liaisons", true),
    new Episode("Supergirl", 5, 6, "Confidence Women", true),
    new Episode("Supergirl", 5, 7, "Tremors", true),
    new Episode("Supergirl", 5, 8, "The Wrath Of Rama Kahn", true),
    ...
    new Episode("Arrow", 8, 4, "Present Tense", true),
    new Episode("The Flash", 6, 5, "Kiss Kiss Breach Breach", true),
    new Episode("Arrow", 8, 5, "Prochnost", true),
    new Episode("The Flash", 6, 6, "License To Elongate", true),
    new Episode("The Flash", 6, 7, "The Last Temptation Of Barry Allen Part 1", true),
    new Episode("The Flash", 6, 8, "The Last Temptation Of Barry Allen Part 2", true),
    new Episode("Arrow", 8, 6, "Reset", true),
    new Episode("Arrow", 8, 7, "Purgatory", true),
    ...
    new Episode("Batwoman", 1, 5, "Mine Is A Long And A Sad Tale", true),
    new Episode("Batwoman", 1, 6, "I'll Be Judge, I'll Be Jury", true),
    new Episode("Batwoman", 1, 7, "Tell Me The Truth", true),
    new Episode("Batwoman", 1, 8, "A Mad Tea-Party", true),
    new Episode("Supergirl", 5, 9, "Crisis On Infinite Earths Hour One", true),
    new Episode("Batwoman", 1, 9, "Crisis On Infinite Earths Hour Two", true),
    new Episode("The Flash", 6, 9, "Crisis On Infinite Earths Part 3", true),
    ...
    new Episode("Arrow", 8, 10, "Fadeout", false),
