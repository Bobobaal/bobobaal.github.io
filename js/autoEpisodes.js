...
const collapse6 = [new Episode("The Flash", 5, 1, "Nora", true),
    ...
    new Episode("DC Legends Of Tomorrow", 4, 15, "Terms Of Service", false),
    new Episode("DC Legends Of Tomorrow", 4, 16, "Hey, World!", false),
    ...
    new Episode("Supergirl", 4, 16, "The House of L", false),
    new Episode("Supergirl", 4, 17, "All About Eve", false),
    new Episode("Supergirl", 4, 18, "Crime And Punishment", false),
    ...
    new Episode("Supergirl", 4, 22, "The Quest For Peace", false),
    ...
    new Episode("The Flash", 5, 22, "Legacy", false),
